...
export default connect(
  'cardholder_payment, card_number_payment, security_code_payment, expired_month_payment, expired_year_payment, status_cod_payment',
  actions
)(withRouter(Payment));
