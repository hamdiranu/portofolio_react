    ...
    render (){
        ...
        if (localStorage.getItem("is_login")){
            ...
            <Navbar fixed="top" className="navbar_react" collapseOnSelect expand="lg" bg="dark" variant="dark" >
                ...
                <Navbar.Brand href="#home"><Link to="/cart" style={{color:'black', textDecoration:'none'}}><img className="mr-lg-4 logo-react" src={cartLogo} alt="" /></Link></Navbar.Brand>
            ...
            return (
                <Navbar fixed="top" className="navbar_react" collapseOnSelect expand="lg" bg="dark" variant="dark" >
                    ...
                    <ButtonGroup className="mr-lg-4" aria-label="Second group">
                        <Button variant="outline-secondary"><Link to="/signUp" style={{color:'black', textDecoration:'none'}}>Sign Up</Link></Button>
                    </ButtonGroup>
                    <ButtonGroup aria-label="Third group">
