          ...
          <div className="container-fluid">
            <div className="row profileBody-row">
              ...
              <div className="col-md-7">
                <div
                  className="info_profil"
                  style={{ border: '1px solid black', backgroundColor: '#7F7D7E', color: 'beige' }}
                >
...
export default connect(
  'user_detail,is_login, email, photo, username',
  actions
)(withRouter(BodyProfile));
