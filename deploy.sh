...
kubectl -n coba --kubeconfig kubeconfig set image deployment/${APP_K8S_DEPLOYMENT_NAME} ${APP_K8S_CONTAINER_NAME}=hamdiranu/containerd:frontend-${TRAVIS_BUILD_NUMBER}
